...
public class EmployeeTracking extends FragmentActivity implements OnMapReadyCallback,
    ...
    private Circle custommerMarker;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnStart = (Button)findViewById(R.id.btnStartWork);
        btnStart.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if(btnStart.getText().equals("START"))
                {
                    WorkLocation = Common.mLastLocation;
                    btnStart.setText("End Work Now");
                }
                else if(btnStart.getText().equals("End Work Now"))
                {
                    calculateCashFee(WorkLocation,Common.mLastLocation);
                }
            }
        });
    ...
    private void calculateCashFee(final Location workLocation, Location mLastLocation) {
        ...
        try {
            ...
            requestApi = "https://maps.googleapis.com/maps/api/directions/json?"+
                    ...
                    "origin="+workLocation.getLatitude()+","+workLocation.getLongitude()+"&"+
                    ...
                    .enqueue(new Callback<String>() {
                        ...
                        public void onResponse(Call<String> call, Response<String> response) {
                            ...
                            try {
                                ...
                                sendWorkEndNotification(customerId);

                                //new Activity
                                Intent intent = new Intent(EmployeeTracking.this,workDetail.class);
                                ...
                                intent.putExtra("location_start",String.format("%f, f",workLocation.getLatitude(),workLocation.getLongitude()));
                        ...
                        public void onFailure(Call<String> call, Throwable t) {
                            Toast.makeText(EmployeeTracking.this,""+t.getMessage(), Toast.LENGTH_SHORT).show();
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        custommerMarker = mMap.addCircle(new CircleOptions()
                  .center(new LatLng(Double.parseDouble(customerlat),Double.parseDouble(customerlng)))
                   .radius(50)
...
//                String.format("Employee has arrived at your Location",Common.currentFixItEmployee.getName()));
//        Sender sender = new Sender(token.getToken(),notification);

        Map<String,String> content = new HashMap<>();
        content.put("title","Arrived");
        content.put("message",String.format("Employee has arrived at your Location",Common.currentFixItEmployee.getName()));
    ...
    private void sendWorkEndNotification(String customerId) {
        Token token = new Token(customerId);
//        Notification notification = new Notification("WorkEnd",customerId);
//        Sender sender = new Sender(token.getToken(),notification);

        Map<String,String> content = new HashMap<>();
        content.put("title","WorkEnd");
    ...
    private void displayLocation() {
        ...
        if(Common.mLastLocation != null)
        {
                ...
                employeeMarker = mMap.addMarker(new MarkerOptions().position(new LatLng(latitude,longitude))
                .title("You")
    ...
    private class ParserTask extends AsyncTask<String,Integer,List<List<HashMap<String,String>>>>
    {
        ...
        ProgressDialog mDialog = new ProgressDialog(EmployeeTracking.this);
